...
> **Lingzhi quota**: Lingzhi quota queries have been retired and are now served by **quota-api**. Please query via `http://127.0.0.1:8101/api/quotas`. CC Switch no longer produces a billing unit for the Lingzhi provider.
